window.Webflow ||= [];
window.Webflow.push(() => {
  // const name = 'Samuel hey';
  // greetUser(name);
  // const map = document.querySelector<HTMLElement>('[tq-element="map"]');
  ...
  //40.71328263476621, -73.95806496031473
  ...
  //           el.innerHTML = `<div class="card-price">${androidPlanPricing[1].price.currency.symbol}${androidPlanPricing[1].price.amount}<span class="price-span">/ month</span></div>`;
  //         }
  //       });

  //       priceElement.forEach((el) => {
  //         if (el.closest('.anual-tab-pane')) {
  //           el.innerHTML = `<div class="card-price">${androidPlanPricing[0].price.currency.symbol}${androidPlanPricing[0].price.amount}<span class="price-span">/ month</span></div>`;
  //         }
  //       });
  ...
  //           el.innerHTML = `<div class="card-price">${emailPlanPricing.currency.symbol}${emailPlanPricing.amount}<span class="price-span">/ month</span></div>`;
  //         }
  //       });
  ...
  //           el.innerHTML = `<div class="card-price">${filteringPlanPricing[1].price.currency.symbol}${filteringPlanPricing[1].price.amount}<span class="price-span">/ month</span></div>`;
  //         }
  //       });
  ...
  //           el.innerHTML = `<div class="card-price">${filteringPlanPricing[0].price.currency.symbol}${filteringPlanPricing[0].price.amount}<span class="price-span">/ month</span></div>`;
  //         }
  //       });
  //     } catch (err) {
  //       alert(err);
  ...
  // google API   AIzaSyB2_OAZjrFcXz12uXjKoGC1zBt-WBWBsxg
  //googleMap
});

// androidPlanPricing, blockPlanPricing, emailPlanPricing, filteringPlanPricing
//<div class="card-price">£39.49 <span class="price-span">/ month</span></div>
//filteringPlanPricing[1].price.amount
